...
| RAM | CACHE | 
| --- | ----- |
| <style="width: 50%">RAM is a volatile memory which could store the data as long as the power is supplied.</style> | <style="width: 50%">Cache is a smaller and fast memory component in the computer.</style>  |
